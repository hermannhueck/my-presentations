...
""".stripMargin
  ...
  val projects = List(
    Project("A Taste of Dotty", "taste-of-dotty", "taste-of-dotty.pdf"),
    ...
    Project(
      ...
      "composing-functions",
      "From-Function1%23apply-to-Kleisli.pdf"
    ),
    Project(
      "Use Applicative where applicable!",
      "use-applicative-where-applicable",
      "use-applicative-where-applicable.pdf"
    ),
    ...
    Project(
      ...
      "Future-vs-Monix-Task.pdf"
    ),
    Project(
      "From Functor Composition to Monad Transformers",
      "monad-transformers",
      "from-functor-composition-to-monad-transformers.pdf"
    ),
    Project(
      "Composing an App with Free Monads (using Cats)",
      "free-monad-app",
      "composing-an-app-with-free-monads.pdf"
    ),
